...
class RestaurantManagement:
    def __init__(self,window):
        self.window=window
        self.window.title("Management System")
    ...
    def setup_background(self,root):
        ...
        canvas.pack()
        original_image = tk.PhototImage(file="background.png")
    ...
    def update_menu_prices(self, *args):
        ...
        for item, label in self.menu_items[items] * rate
    ...
    def place_order(self):
        ...
        if total_cost > 0:
            ...
            messagebox.showerror("Error", "Please order at least one items.")
